...
1. 尊敬の念を持ち、礼儀正しくあること。
2. なりすましをしないこと。
3. 政治的・宗教的な議論及びそれに類するものはしないこと。
4. 著作権侵害の禁止/無料配布の要求/犯罪に関する議論はしないこと。
5. NSFW/NSFLコンテンツは投稿しないこと。
6. 個人を特定できる情報を含まないこと。
7. ネタバレ要素がある場合、ネタバレタグを使い、参加者を考慮すること。
8. スパム行為や迷惑メッセージの送信をしないこと。
9. Discordのサービス規約およびコミュニティガイドラインに従うこと。
　 https://discord.com/terms　https://discord.com/guidelines
10. 楽しむこと。
11. ルール違反等が見受けられた場合や、気がかりな行為、判断に迷う言動があった場合は #⁠inquiry チャンネルでチケットを発行してご連絡ください。
...
2. Do not impersonate others.
3. Do not engage in political or religious discussions, or anything similar.
4. Do not infringe on copyrights, request free distributions, or discuss criminal activities.
5. Do not post NSFW/NSFL content.
6. Do not include personally identifiable information.
7. If there are spoilers, use spoiler tags and be considerate of other participants.
8. Do not engage in spamming or sending nuisance messages.
9. Follow the [Discord Terms of Service](https://discord.com/terms) and [Discord Community Guidelines](https://discord.com/guidelines).
10. Have fun!
